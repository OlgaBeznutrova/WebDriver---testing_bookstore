...
class TestUserAddToBasketFromProductPage:
    ...
    def setup(self, browser):
        ...
        login_page.open()
        login_page.register_new_user(str(time.time()) + "@fakemail.org", str(time.time()) + "Passw0rd")
...
def test_guest_can_add_product_to_basket(browser, link):
    ...
    product_page.open()
    product_page.should_be_product_added_to_basket_quiz()
...
def test_guest_cant_see_product_in_basket_opened_from_product_page(browser):
    ...
    basket_page.should_not_be_disappeared_message_about_empty_basket()
